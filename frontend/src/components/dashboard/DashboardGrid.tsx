...
import { ArrowUpRight, CalendarDays, Clock3, UserPlus, CalendarPlus, ClipboardCheck, BarChart3 } from "lucide-react";

function SectionHeading({ eyebrow, title }: { eyebrow: string; title: string }) {
  return (
    <div>
      <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--muted)]">{eyebrow}</p>
      <h2 className="mt-1 font-display text-lg font-bold tracking-tight text-[var(--text)]">{title}</h2>
    </div>
  );
}
      ...
      <div className="grid gap-4 xl:grid-cols-12">
        ...
        <div className="card xl:col-span-8 p-6">
          <div className="mb-6 flex items-center justify-between">
            <SectionHeading eyebrow="Analytics" title="Attendance Overview" />
        ...
        <div className="space-y-4 xl:col-span-4">
          ...
          {/* Quick Actions */}
          <div className="card p-6">
            <h2 className="mb-4 font-display text-lg font-bold tracking-tight text-[var(--text)]">Quick Actions</h2>
      ...
      <div className="grid gap-4 xl:grid-cols-12">
        ...
        <div className="card xl:col-span-4 p-6">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="font-display text-lg font-bold tracking-tight text-[var(--text)]">Upcoming Events</h2>
