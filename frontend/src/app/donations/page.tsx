...
export default function DonationsPage() {
  ...
  const loadData = async () => {
    try {
      ...
      setSummary((summaryRes?.data ?? summaryRes) as DonationSummary);
    } catch (err) {
      setError(
        err instanceof Error ? err.message : "Unable to load donations"
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Unable to save donation"
      );
    }
  };
      ...
      <div className="space-y-6">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold">
            Donation history and giving insights
          </h1>
          <p className="mt-2 text-sm text-[var(--muted)]">
            Track contributions and monitor giving progress.
          </p>
        </div>
          ...
          <Card title="Donation history" description="Recent contributions">
            ...
            {loading ? (
              ...
              <EmptyState
                ...
                description="Add the first donation to start tracking giving."
              />
            ) : (
